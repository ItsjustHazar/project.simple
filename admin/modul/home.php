					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?=$data['nama_lengkap']; ?></b> | Aplikasi Presensi Siswa</h5>
							</div>
							...
							<div class="card full-height">
								<div class="card-body">
									...
									<div class="card-category">
										<center>
									<br>Aplikasi Berbasis Web Presensi Siswa
										</center>
									</div>
