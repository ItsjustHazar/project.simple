...
<?php
 ...
 ?>
   ...
   // jumlah siswa
$jumlahSiswa = mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_siswa WHERE status='Y' "));
// jumlah guru
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kepsek&act=add ">
											<span class="sub-item"> Tambah Wali Murid </span>
										</a>
									</li>
									<li>
										<a href="?page=kepsek">
											<span class="sub-item"> Daftar Wali Murid </span>
										</a>
									</li>
								</ul>
							</div>
